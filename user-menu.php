<nav class="navbar navbar-expand bg-info navbar-dark px-5">
    ...
    <ul class="navbar-nav ms-auto">
        <li class="nav-item">
            <a href="profile.php" class="nav-link text-white"><i class="me-1 fa-solid fa-user text-white mr-1"></i>Welcome <?= $_SESSION['full_name']; ?></a>
        </li>
        <li class="nav-item">
            <a href="logout.php" class="nav-link text-white" ><i class="me-1 fa-solid fa-user"></i>Logout</a>
        </li>
    </ul>
</nav>
